    ...
    execute: function () {
      ...
      _export("NetworkConnect", NetworkConnect = (_dec = ccclass("NetworkConnect"), _dec2 = property({
        ...
        updatePlayerList(playerList) {
          ...
          for (var _i = displayIndexR; _i < this.ListR.length; _i++) {
            this.ListR[_i].active = false;
          }
        }
        ...
        createSpriteNode(sessionId, betAmount) {
          ...
          for (var _i2 = 0; _i2 < this.ListLabelR.length; _i2++) {
            if (sessionId === this.ListLabelR[_i2].string) {
              // Thêm node mới làm con của node có label tương ứng
              if (this.UserBet === "Dragon") {
                PosTarget = this.DragonNode;
                this.parentNodeChip = this.ChipParent[0];
              ...
              this.ListLabelR[_i2].node.addChild(spriteNode);

              this.ListLabelR[_i2].node.inverseTransformPoint(v3, PosTarget.worldPosition);
