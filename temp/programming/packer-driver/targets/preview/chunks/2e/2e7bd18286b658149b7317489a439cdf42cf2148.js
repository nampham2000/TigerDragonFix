System.register(["isomorphic-form-data", "cross-fetch"], function (_export, _context) {
  ...
  var fetch, Service, Query, AppwriteException, Client, Account, Avatars, Databases, Functions, Graphql, Locale, Messaging, Storage, Teams, Permission, Role, ID, AuthenticatorType, AuthenticationFactor, OAuthProvider, Browser, CreditCard, Flag, ExecutionMethod, ImageGravity, ImageFormat;
          ...
          this.realtime = {
            ...
            createSocket: () => {
              ...
              ((_a = this.realtime.socket) === null || _a === void 0 ? void 0 : _a.readyState) > WebSocket.OPEN // Check if WebSocket is CLOSING (3) or CLOSED (4)
                ...
                if (this.realtime.socket && ((_b = this.realtime.socket) === null || _b === void 0 ? void 0 : _b.readyState) < WebSocket.CLOSING // Close WebSocket if it is CONNECTING (0) or OPEN (1)
                ) {
...
//# sourceMappingURL=2e7bd18286b658149b7317489a439cdf42cf2148.js.map