System.register(["isomorphic-form-data", "cross-fetch"], function (_export, _context) {
  "use strict";

  var fetch, Service, Query, AppwriteException, Client, Account, Avatars, Databases, Functions, Graphql, Locale, Messaging, Storage, Teams, Permission, Role, ID, _a, _ID_hexTimestamp, AuthenticatorType, AuthenticationFactor, OAuthProvider, Browser, CreditCard, Flag, ExecutionMethod, ImageGravity, ImageFormat;
  ...
  ***************************************************************************** */
  ...
  _export({
    AuthenticatorType: void 0,
    AuthenticationFactor: void 0,
    OAuthProvider: void 0,
    Browser: void 0,
    CreditCard: void 0,
    Flag: void 0,
    ExecutionMethod: void 0,
    ImageGravity: void 0,
    ImageFormat: void 0
  });

  return {
    setters: [function (_isomorphicFormData) {}, function (_crossFetch) {
      fetch = _crossFetch.fetch;
    }],
    execute: function () {
      ...
      _export("Query", Query = class Query {
      ...
      _export("AppwriteException", AppwriteException = class AppwriteException extends Error {
      ...
      _export("Client", Client = class Client {
        constructor() {
          ...
          this.realtime = {
            ...
            createSocket: () => {
              ...
              var url = this.config.endpointRealtime + '/realtime?' + channels.toString();
              ...
              ((_b = this.realtime.socket) === null || _b === void 0 ? void 0 : _b.readyState) > WebSocket.OPEN // Check if WebSocket is CLOSING (3) or CLOSED (4)
                ...
                this.realtime.socket.addEventListener('close', event => {
                  ...
                  var timeout = this.realtime.getTimeout();
              ...
              try {
                ...
                switch (message.type) {
                  case 'connected':
                    ...
                    var session = cookie === null || cookie === void 0 ? void 0 : cookie["a_session_" + this.config.project];
                  ...
                  case 'event':
                    ...
                    if (data === null || data === void 0 ? void 0 : data.channels) {
                      var isSubscribed = data.channels.some(channel => this.realtime.channels.has(channel));
            ...
            cleanUp: channels => {
              this.realtime.channels.forEach(channel => {
                if (channels.includes(channel)) {
                  var found = Array.from(this.realtime.subscriptions).some(_ref => {
                    var [_key, subscription] = _ref;
        ...
        call(method, url, headers, params) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            if (method === 'GET') {
              for (var [key, value] of Object.entries(Service.flatten(params))) {
              ...
              switch (headers['content-type']) {
                ...
                case 'multipart/form-data':
                  ...
                  var _loop = function* _loop(_key2) {
                    if (Array.isArray(params[_key2])) {
                      params[_key2].forEach(value => {
                        formData.append(_key2 + '[]', value);
                      });
                    } else {
                      formData.append(_key2, params[_key2]);
                    }
                  };
            ...
            try {
              var data = null;
              var response = yield fetch(url.toString(), options);
              ...
              var cookieFallback = response.headers.get('X-Fallback-Cookies');
      ...
      _export("Account", Account = class Account extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        get() {
          return __awaiter(this, void 0, void 0, function* () {
            var apiPath = '/account';
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
        ...
        */
        ...
        deleteIdentity(identityId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/account/identities/{identityId}'.replace('{identityId}', identityId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
        ...
        */
        ...
        createMfaAuthenticator(type) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/account/mfa/authenticators/{type}'.replace('{type}', type);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('post', uri, {
              'content-type': 'application/json'
        ...
        */
        ...
        createOAuth2Session(provider, success, failure, scopes) {
          ...
          var apiPath = '/account/sessions/oauth2/{provider}'.replace('{provider}', provider);
          var payload = {};
          ...
          for (var [key, value] of Object.entries(Service.flatten(payload))) {
        ...
        */
        ...
        getSession(sessionId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/account/sessions/{sessionId}'.replace('{sessionId}', sessionId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
        ...
        */
        ...
        updatePushTarget(targetId, identifier) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/account/targets/{targetId}/push'.replace('{targetId}', targetId);
            var payload = {};
        ...
        */
        ...
        createOAuth2Token(provider, success, failure, scopes) {
          ...
          var apiPath = '/account/tokens/oauth2/{provider}'.replace('{provider}', provider);
          var payload = {};
      ...
      _export("Avatars", Avatars = class Avatars extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        getBrowser(code, width, height, quality) {
          ...
          var apiPath = '/avatars/browsers/{code}'.replace('{code}', code);
          var payload = {};
        ...
        */
        ...
        getCreditCard(code, width, height, quality) {
          ...
          var apiPath = '/avatars/credit-cards/{code}'.replace('{code}', code);
          var payload = {};
        ...
        */
        ...
        getFlag(code, width, height, quality) {
          ...
          var apiPath = '/avatars/flags/{code}'.replace('{code}', code);
          var payload = {};
      ...
      _export("Databases", Databases = class Databases extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        listDocuments(databaseId, collectionId, queries) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/databases/{databaseId}/collections/{collectionId}/documents'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId);
            var payload = {};
        ...
        */
        ...
        getDocument(databaseId, collectionId, documentId, queries) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/databases/{databaseId}/collections/{collectionId}/documents/{documentId}'.replace('{databaseId}', databaseId).replace('{collectionId}', collectionId).replace('{documentId}', documentId);
            var payload = {};
      ...
      _export("Functions", Functions = class Functions extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        listExecutions(functionId, queries, search) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/functions/{functionId}/executions'.replace('{functionId}', functionId);
            var payload = {};
        ...
        */
        ...
        getExecution(functionId, executionId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/functions/{functionId}/executions/{executionId}'.replace('{functionId}', functionId).replace('{executionId}', executionId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
      ...
      _export("Graphql", Graphql = class Graphql extends Service {
        constructor(client) {
          super(client);
        }
        /**
      ...
      _export("Locale", Locale = class Locale extends Service {
        constructor(client) {
          super(client);
        }
        /**
      ...
      _export("Messaging", Messaging = class Messaging extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        createSubscriber(topicId, subscriberId, targetId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/messaging/topics/{topicId}/subscribers'.replace('{topicId}', topicId);
            var payload = {};
        ...
        */
        ...
        deleteSubscriber(topicId, subscriberId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/messaging/topics/{topicId}/subscribers/{subscriberId}'.replace('{topicId}', topicId).replace('{subscriberId}', subscriberId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('delete', uri, {
              'content-type': 'application/json'
      ...
      _export("Storage", Storage = class Storage extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        listFiles(bucketId, queries, search) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/storage/buckets/{bucketId}/files'.replace('{bucketId}', bucketId);
            var payload = {};
        ...
        */
        ...
        createFile(bucketId, fileId, file, permissions, onProgress) {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            while (offset < size) {
              var end = Math.min(offset + Service.CHUNK_SIZE - 1, size - 1);
              ...
              var chunk = file.slice(offset, end + 1);
        ...
        */
        ...
        getFile(bucketId, fileId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/storage/buckets/{bucketId}/files/{fileId}'.replace('{bucketId}', bucketId).replace('{fileId}', fileId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
        ...
        */
        ...
        getFileDownload(bucketId, fileId) {
          ...
          var apiPath = '/storage/buckets/{bucketId}/files/{fileId}/download'.replace('{bucketId}', bucketId).replace('{fileId}', fileId);
          var payload = {};
          var uri = new URL(this.client.config.endpoint + apiPath);
          payload['project'] = this.client.config.project;
        ...
        */
        ...
        getFilePreview(bucketId, fileId, width, height, gravity, quality, borderWidth, borderColor, borderRadius, opacity, rotation, background, output) {
          ...
          var apiPath = '/storage/buckets/{bucketId}/files/{fileId}/preview'.replace('{bucketId}', bucketId).replace('{fileId}', fileId);
          var payload = {};
        ...
        */
        ...
        getFileView(bucketId, fileId) {
          ...
          var apiPath = '/storage/buckets/{bucketId}/files/{fileId}/view'.replace('{bucketId}', bucketId).replace('{fileId}', fileId);
          var payload = {};
          var uri = new URL(this.client.config.endpoint + apiPath);
          payload['project'] = this.client.config.project;
      ...
      _export("Teams", Teams = class Teams extends Service {
        constructor(client) {
          super(client);
        }
        /**
        ...
        */
        ...
        get(teamId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/teams/{teamId}'.replace('{teamId}', teamId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
        ...
        */
        ...
        listMemberships(teamId, queries, search) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/teams/{teamId}/memberships'.replace('{teamId}', teamId);
            var payload = {};
        ...
        */
        ...
        getMembership(teamId, membershipId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/teams/{teamId}/memberships/{membershipId}'.replace('{teamId}', teamId).replace('{membershipId}', membershipId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
        ...
        */
        ...
        updateMembershipStatus(teamId, membershipId, userId, secret) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/teams/{teamId}/memberships/{membershipId}/status'.replace('{teamId}', teamId).replace('{membershipId}', membershipId);
            var payload = {};
        ...
        */
        ...
        getPrefs(teamId) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            var apiPath = '/teams/{teamId}/prefs'.replace('{teamId}', teamId);
            var payload = {};
            var uri = new URL(this.client.config.endpoint + apiPath);
            return yield this.client.call('get', uri, {
              'content-type': 'application/json'
      ...
      _export("Permission", Permission = class Permission {});
      ...
      _export("ID", ID = class ID {
        static custom(id) {
          return id;
        }

        static unique(padding) {
          if (padding === void 0) {
            padding = 7;
          }

          // Generate a unique ID with padding to have a longer ID
          var baseId = __classPrivateFieldGet(ID, _a, "m", _ID_hexTimestamp).call(ID);
      ...
      _a = ID, _ID_hexTimestamp = function _ID_hexTimestamp() {
        ...
        var msec = now.getMilliseconds(); // Convert to hexadecimal
      ...
      })(AuthenticatorType || _export("AuthenticatorType", AuthenticatorType = {}));
      ...
      })(AuthenticationFactor || _export("AuthenticationFactor", AuthenticationFactor = {}));
      ...
      })(OAuthProvider || _export("OAuthProvider", OAuthProvider = {}));
      ...
      })(Browser || _export("Browser", Browser = {}));
      ...
      })(CreditCard || _export("CreditCard", CreditCard = {}));
      ...
      })(ExecutionMethod || _export("ExecutionMethod", ExecutionMethod = {}));
      ...
      })(ImageGravity || _export("ImageGravity", ImageGravity = {}));
...
//# sourceMappingURL=e1108bb882698dbb37aa25c8bd4a8d4bd55acec9.js.map