      ...
      _export("GameController", GameController = (_dec = ccclass("GameController"), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          if (this.NetworkConnect.room && this.NetworkConnect.room.sessionId !== undefined) {
            var player = this.NetworkConnect.room.state.players.get(this.NetworkConnect.room.sessionId);
          ...
          if (this.NetworkConnect && this.NetworkConnect.room && this.NetworkConnect.room.state && this.NetworkConnect.room.state.players) {
            var _player = this.NetworkConnect.room.state.players.get(this.NetworkConnect.currentHost);

            if (_player && _player.displayName) {
              this.currentHostName = _player.displayName;
            } else {
          ...
          if (this.NetworkConnect.gameState === "payout" && this.GameStatePayOut === false) {
            ...
            for (var _i = 0; _i < this.NetworkConnect.ListLabelR.length; _i++) {
              this.NetworkConnect.ListLabelR[_i].node.removeAllChildren();
            } // this.createGridNot();
            // this.createGrid();
        ...
        displayImages() {
          ...
          var cardList = suitToResourceMap[this.cardSuit];
          ...
          var spriteComponent = this.CardNodeL.getComponent(Sprite);
        ...
        createGrid(documents) {
          ...
          for (var doc of documents[0].result) {
            var prefabType = prefabMap[doc];
...
//# sourceMappingURL=a93dab76e3238a0b042da75b8858c588f262bd41.js.map