System.register(["__unresolved_0", "stream", "http", "url", "whatwg-url", "https", "zlib", "encoding"], function (_export, _context) {
  "use strict";

  var _cjsLoader, _req, _req0, _req1, _req2, _req3, _req4, _req5, _cjsExports, ___esModule, _default, _Headers, _Request, _Response, _FetchError, __cjsMetaURL;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      _req1 = _url.__cjsMetaURL;
    }, function (_whatwgUrl) {
      _req2 = _whatwgUrl.__cjsMetaURL;
    }, function (_https) {
      _req3 = _https.__cjsMetaURL;
    }, function (_zlib) {
      _req4 = _zlib.__cjsMetaURL;
    }, function (_encoding) {
      _req5 = _encoding.__cjsMetaURL;
    }],
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        const URL = Url.URL || whatwgUrl.URL; // fix an issue where "format", "parse" aren't a named export for node <10
        ...
        const URL$1 = Url.URL || whatwgUrl.URL; // fix an issue where "PassThrough", "resolve" aren't a named export for node <10
        ...
        exports.FetchError = FetchError; // #endregion ORIGINAL CODE
...
//# sourceMappingURL=4d627771fc5427ecabd9f135bebcf8b56f63ca27.js.map